...
class Handler() :
    ...
    def considerActivation(self):
        ...
        v1, v2 = self.getDistance()
       # print(sum(self.recentValues))
        if len(self.recentValues) >9:
            del self.recentValues[0]
            del self.recentValues[0]
        self.recentValues.append(v1)
        self.recentValues.append(v2)
        
        
        if sum(self.recentValues)< 60 and len(self.recentValues) > 9:
            self.fireAlarm(True)
        else:
